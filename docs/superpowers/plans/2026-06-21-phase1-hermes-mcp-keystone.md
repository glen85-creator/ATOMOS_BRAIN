...
```python
    ...
    ATOMOS_MCP_BASE_URL: str = ""         # 예: https://<engine>.up.railway.app/mcp (참조/헬스용)
...
- `ATOMOS_MCP_BASE_URL` = `https://<엔진-railway-도메인>/mcp`
...
Expected: `401` (마운트 정상 + 인증 게이트 동작). `404`면 마운트/배포 실패 → 로그 확인.
