...
declare -A SLOTS=(
  ...
  [ATOMOS_BRAND_DIVISION]=$ATOMOS_BRAND_DIVISION [ATOMOS_CONTENTS_STUDIO]=$ATOMOS_CONTENTS_STUDIO
  [ATOMOS_SCM_TEAM]=$ATOMOS_SCM_TEAM [ATOMOS_FINANCE_TEAM]=$ATOMOS_FINANCE_TEAM
  [ATOMOS_CRM_TEAM]=$ATOMOS_CRM_TEAM [ATOMOS_ARCHIVES_TEAM]=$ATOMOS_ARCHIVES_TEAM
  [ATOMOS_VISION_AI_TEAM]=$ATOMOS_VISION_AI_TEAM
)
